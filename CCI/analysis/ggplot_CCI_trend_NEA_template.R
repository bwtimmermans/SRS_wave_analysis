# source("/home/ben/research/NOC/SRS_wave_analysis/CCI/analysis/ggplot_CCI_trend_NEA.R")
   library(ggplot2)
   library(grid)
   library(gridExtra)
...
# Include blank panels.
   fig_file_name <- paste("./figures/CCI_trends/",res,"deg/trend_CI_",lab_stats[stat_idx],"_",paste(unlist(strsplit(lab_dataset,split=' ')),collapse='-'),"_",lab_years,"_",lab_months,"_",lab_y_centre,"_",flag_reg,"_NEA.png",sep="")
